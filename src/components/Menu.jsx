...
function Menu({ showMenu }) {
  ...
  return (
    <div className={` gap-5 text-[18px] font-medium mr-6 text-stone-800 flex flex-col lg:flex lg:flex-row 
     lg:p-0 lg:static lg:shadow-none shadow-[0_8px_8px_rgba(231,76,60,0.15)] absolute top-[91px] left-0 right-[-35px] pb-25 
     bg-white p-3 px-[5%]  ${showMenu ? "" : "hidden"}`}>
